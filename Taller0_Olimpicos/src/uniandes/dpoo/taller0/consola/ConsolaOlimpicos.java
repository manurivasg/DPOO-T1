...
public class ConsolaOlimpicos
{
	...
	/**
	 * Ejecuta la opción para consultar el país que representa un atleta que el usuario ingresa por 
	 * consola al ejecutar el programa.
	 */
	private void ejecutarPaisAtleta()
	{
		String nombreAtleta = input("Ingrese el nombre del atleta del que desea conocer el país");
		String nombrePais = calculadora.paisAtleta(nombreAtleta);
		System.out.println("El país al que representa el atleta "+nombreAtleta+" es "+nombrePais);
	}
	/**
